control 'V-67387' do
  ...
  describe 'A manual review is required to ensure the Service Master Key is be backed up, stored offline and off-site.' do
    skip 'A manual review is required to ensure the Service Master Key is be backed up, stored offline and off-site.'
  end
end
