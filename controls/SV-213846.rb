...
2 - Full access enabled)
  ...
  filestream_required = input('filestream_required')

  filestream_transact_access_only_required = input('filestream_transact_access_only_required')
